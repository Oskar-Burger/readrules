...
### 
### first run of these functions on EvoLearn data 
...
#########################################################################################
adint = read_excel("TA_EM_ADINT_26FEB2019.xlsx")
chiint = read_excel("TA_EM_CHINT_30MAR2019.xlsx")
partsurv = read_excel("Participant_Survey_4Demo.xlsx")
...
test1 = complex_rbind(adint, partsurv, key_adintpartsurv, gr.nam=1:2, gr.lab='Task')
